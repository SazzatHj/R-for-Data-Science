...
## 📖 2. Free Online Books & Documentation

| Subject | Book Title / Resource | Access Link | Description |
| :--- | :--- | :--- | :--- |
| **R for Data Science** | *R for Data Science (2e)* | 🔗 [Read Online](https://r4ds.hadley.nz/) | Master Tidyverse, dplyr & ggplot2 by Hadley Wickham |
| **Data Viz** | *Fundamentals of Data Visualization* | 🔗 [Read Online](https://clauswilke.com/dataviz/) | Guide to making informative charts and plots |
| **Advanced R** | *Advanced R Programming* | 🔗 [Read Online](https://adv-r.hadley.nz/) | In-depth guide to object-oriented R code |
| **Statistics** | *Introductory Statistics with R* | 🔗 [PDF / Web Link](#) | Applied statistical modeling for research |

---

## 🌐 3. Essential Websites & Practice Portals

* 🌐 [RStudio Education](https://education.rstudio.com/) – Official guides and interactive tutorials for R users.
* 🌐 [R-bloggers](https://www.r-bloggers.com/) – Daily tutorials, news, and R code examples.
